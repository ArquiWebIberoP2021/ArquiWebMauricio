...
{
  //Utilizando reduce, podemos ir separando cada arreglo anhidado e irlo juntando en un  solo arreglo.
  //Debemos empezar a aplanar nivel por nivel e ir concatenando
  var flatten=arr.reduce((total, cantidad)=>{
    return total.concat(cantidad);
  });
  //Ya tenemos nuestro arreglo aplanado. Lo que hicimos fue recorrer cada elemento anhidado y por cada uno ir concatenando los valores..
  return flatten;
